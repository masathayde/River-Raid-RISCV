...
ecallException:   addi    sp, sp, -264              # Salva todos os registradores na pilha
	...
	goToTime:	jal ra     timeEcall                    # chama time
		j       endEcall
...
readChar: 		nop
#DE1(readCharKDMMIODE2)   # Eh necessario mesmo???
...
timeDE2: 	#li 	t0, TimerLOW		# endereco do Timer
...
printIntUnsigned.loop1:	divu 	t4, a0, t2		# divide por 10 (quociente)
		remu 	t3, a0, t2			# resto
		addi 	sp, sp, -4			# aloca espaco na pilha
		sw 	t3, 0(sp)			# coloca resto na pilha
		mv 	a0, t4				# atualiza o numero com o quociente
